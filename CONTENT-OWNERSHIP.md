...
1. Approved company registration and VAT details
2. Final support channels and owner
3. Final shipping, return, privacy, and payment policy language
4. Approved response-time and escalation expectations
5. Final company/about narrative inputs

## Rules

1. No public route is marked final without a named owner and approver.
2. Style samples and business inputs are separate gates. Clearing one does not clear the other.
3. Trust, legal, support, and company-detail surfaces stay non-final until real operating data is approved.
4. Editorial and commerce pages can be implementation-complete while still launch-blocked on voice and approvals.
5. If a route changes meaning, this document must be updated in the same delivery slice.

## Operational implication

The current website can now be validated as a complete system:

- IA
- route graph
- schema
- analytics
- protected ops rehearsal
- release hardening

But it should **not** be described as final public brand copy until this ownership freeze is satisfied with real samples and approved business inputs.
