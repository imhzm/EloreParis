...
- Release hardening now also includes framework-level security headers, a health endpoint, controlled share-preview assets at both site and key surface level, and automated smoke regression gates, but deployment target and monitoring are still undefined.
