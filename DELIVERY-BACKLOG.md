...
- Release hardening now also includes framework-level security headers, a health endpoint, and controlled share-preview assets at both site and key surface level, but deployment target and monitoring are still undefined.
