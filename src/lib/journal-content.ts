...
export const journalContent: Record<Locale, Record<JournalSlug, JournalRecord>> = {
  ar: {
    ...
    "after-shower-bodycare-by-texture": {
      slug: "after-shower-bodycare-by-texture", category: "العناية بالجسم", eyebrow: "BODY / TEXTURE", title: "عناية الجسم بعد الاستحمام\nتبدأ من القوام.", summary: "اختاري اللحظة والمناطق أولًا، ثم قرري إن كان القوام الخفيف أو الأغنى أنسب.", answer: "اربطي القوام بوقت الاستخدام والمناطق التي تلاحظينها، وابدئي بكمية محدودة. لا يعني القوام الأغنى أنه أفضل تلقائيًا، ولا يحول الجفاف إلى تشخيص.", readingLabel: "دليل مختصر · 4 دقائق", image: assets.serum, imageAlt: "دراسة مفاهيمية لقوام العناية؛ ليست صورة منتج للجسم", sections: [
  ...
  en: {
    ...
    "after-shower-bodycare-by-texture": {
      slug: "after-shower-bodycare-by-texture", category: "Bodycare", eyebrow: "BODY / TEXTURE", title: "After-shower bodycare\nbegins with texture.", summary: "Choose the moment and areas first, then decide whether lighter or richer feels more suitable.", answer: "Connect texture to the moment and areas you notice, beginning with a limited amount. Richer is not automatically better, and dryness is not a diagnosis.", readingLabel: "Concise guide · 4 minutes", image: assets.serum, imageAlt: "Concept care texture; not a body product photograph", sections: [
    ...
    "read-an-ingredient-before-you-choose": {
      slug: "read-an-ingredient-before-you-choose", category: "Ingredients, simplified", eyebrow: "INGREDIENT / CONTEXT", title: "Read an ingredient\nbefore it becomes a decision.", summary: "An ingredient name begins the research; it never proves quality or fit on its own.", answer: "Begin with the ingredient's role, then read the formula, texture, timing and directions together. Change one element at a time and never infer efficacy from name or concentration alone.", readingLabel: "Concise guide · 5 minutes", image: assets.skin, imageAlt: "Concept skin and light image; not ingredient efficacy evidence", sections: [
