...
- Current focus: release-hardening completion through dedicated social preview assets for commerce and editorial surfaces on the storefront running on port `3056`
...
| Validation | 10% | In Progress | 72% | Lint, typecheck, tests, UX QA, SEO/schema QA, accessibility QA |
| Release | 10% | In Progress | 52% | Deployment target, configs, monitoring, legal/trust gates, rollback path |
