...
- Current focus: first live-host blockers after freezing the primary persistent hosting path and wiring a live Render deploy plus post-deploy verification path
...
| Release | 10% | In Progress | 99% | Deployment target, configs, monitoring, legal/trust gates, rollback path |
